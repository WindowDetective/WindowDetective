...
foldersTree.treeID = "Frameset"
    insFld(foldersTree, gLnk("R", "Introduction", "./intro.html"))
    insFld(foldersTree, gLnk("R", "Features", "./features.html"))
    sub1 = insFld(foldersTree, gFld("Selecting a window", "javascript:parent.op()"))
        ...
        insDoc(sub1, gLnk("R", "Searching for a window", "./finding_windows.html"))
    ...
    sub1 = insFld(foldersTree, gFld("Settings", "javascript:parent.op()"))
        sub2 = insFld(sub1, gFld("Preferences", "./preferences_overview.html"))
            insFld(sub2, gLnk("R", "General", "./preferences_general.html"))
            insFld(sub2, gLnk("R", "Window Tree", "./preferences_window_tree.html"))
            insFld(sub2, gLnk("R", "Picker", "./preferences_picker.html"))
            insFld(sub2, gLnk("R", "Logging", "./preferences_logging.html"))
            insFld(sub2, gLnk("R", "Styles", "./preferences_styles.html"))
      insFld(sub1, gLnk("R", "Smart Settings", "./smart_settings.html"))